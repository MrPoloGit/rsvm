...
logic                          out_ready_i;
logic                          out_valid_o;
logic signed [2*DataWidth-1:0] y_o;
...
function automatic logic signed [2*DataWidth-1:0] expected_mul(
...
task automatic test(
    ...
    logic signed [2*DataWidth-1:0] expected_result;
    logic signed [2*DataWidth-1:0] received_result;
