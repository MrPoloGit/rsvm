...
logic                 ready_d [DataWidth];
logic                 ready_q [DataWidth];
        ...
        always_comb begin
            ...
            if (out_ready_i) begin
                if (i == 0) begin
                    ...
                    if (i == (DataWidth-1)) ready_d[DataWidth-1] = out_ready_i || !valid_q[DataWidth-1];
                    else ready_d[i] = ready_q[i+1];
                end
            end
        end
...
// assign in_ready_o = out_ready_i || !valid_q[DataWidth-1];
